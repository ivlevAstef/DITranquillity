Pod::Spec.new do |s|
  ...
  s.ios.source_files = core_files, module_files, scan_files, ios_tvos_storyboard_files, header_file
  s.tvos.source_files = core_files, module_files, scan_files, ios_tvos_storyboard_files, header_file
  s.osx.source_files = core_files, module_files, scan_files, osx_storyboard_files, header_file
