...
extension DIContainer {
    ...
    /// Creates a dependency graph for analysis and validation.
    ///
    /// The graph represents all registered components and their dependencies,
    /// allowing you to validate the DI configuration and analyze dependency relationships.
    ///
    /// - Returns: A `DIGraph` containing all vertices and dependency edges.
    ///
    /// ## Validation
    ///
    /// ```swift
    ...
    /// }
    ///
    /// // Find cycles (without full validation)
    ...
    /// let missing = graph.vertices.compactMap { vertex -> DIAType? in
