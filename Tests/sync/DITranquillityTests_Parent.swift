...
class DITranquillityTests_Parent: XCTestCase {
    ...
    func test05_PriorityResolve() {
        ...
        let pA: P? = pContainer.resolve()
        let pB: P? = container.resolve()
    ...
    func test06_Many() {
        ...
        let pOne: [P] = many(pContainer.resolve())
        let pTwo: [P] = many(container.resolve())
