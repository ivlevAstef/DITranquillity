...
class DITranquillityTests_Lifetime: XCTestCase {
    ...
    func test01_single() {
        ...
        let service1: FooService = container.resolve()
        XCTAssertEqual(service1.foo(), "foo")
        XCTAssertEqual(initCount, 1)
        
        let service2: FooService = container.resolve()
    ...
    func test02_perApplication() {
        ...
        let service1: FooService = container1.resolve()
        XCTAssertEqual(service1.foo(), "foo")
        
        let service2: FooService = container2.resolve()
        XCTAssertEqual(service2.foo(), "foo")
        XCTAssert(service1 !== service2)
    }
    ...
    func test02_perApplicationWeakRelease() {
        ...
        var service1: FooService? = container.resolve()
        XCTAssertEqual(service1?.foo(), "foo")
        XCTAssertEqual(initCount, 1)
        service1 = nil
    ...
    func test02_perApplicationWeakRetain() {
        ...
        let service3: FooService! = container.resolve()
    ...
    func test03_perContainer() {
        ...
        let service11: FooService = container1.resolve()
    ...
    func test07_customScope() {
        ...
        let obj1: D = container.resolve()
        let obj2: D = container.resolve()
        
        scope.clean()
        
        let obj3: D = container.resolve()
    ...
    func test07_customWeakScope() {
        ...
        var obj1: D? = container.resolve()
        var obj2: D? = container.resolve()
        XCTAssert(obj1 != nil)
        XCTAssert(obj2 != nil)
        XCTAssert(obj1 === obj2)
