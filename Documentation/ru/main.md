...
* [5 времен жизни: single, perRun(.weak/.strong), perContainer(.weak/.strong), objectGraph, prototype, custom](lifetime.md#Время-жизни)
...
* [Пользовательский (custom)](lifetime.md#Пользовательский-custom)
