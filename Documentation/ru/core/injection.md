...
Основное достоинство - поддерживает работу с [модификаторами](modificated_injection.md), а также позволяет внедрять объекты не зарегестрированные в контейнере.
